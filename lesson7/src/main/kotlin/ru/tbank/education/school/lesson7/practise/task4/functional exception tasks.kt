 ...
 * ```
 */
fun parseWithDefault(input: String, default: Int): Int = runCatching { input.toInt() }.getOrDefault(default)
 ...
 * ```
 */
fun safeDivideLogged(a: Int, b: Int): Result<Double> = runCatching { a.toDouble() / b.toDouble() }.onFailure { e -> println("Error with divide ${e.message}") }